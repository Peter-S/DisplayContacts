package com.example.lmnop.displaycontacts;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listContacts = (TextView) findViewById(R.id.lsitContacts);
            ...
            while (cursor.moveToNext()) {
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    while (cursor2.moveToNext()) {
                        String phoneNumber = cursor2.getString(cursor2.getColumnIndex
